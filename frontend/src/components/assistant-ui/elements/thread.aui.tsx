...
export type ThreadProps = {
   ...
   * maintained composer intact while withholding unsupported attachments until
   * the host contract accepts structured file and image parts.
   */
...
export const Thread: FC<ThreadProps> = ({
  ...
  return (
    ...
    </ThreadConfigurationContext.Provider>
  );
};
...
const DefaultComposer: FC<ThreadComposerProps> = ({
  ...
  const shell = (
    ...
    >
      ...
      <ComposerPrimitive.Input
        ...
        addAttachmentOnPaste={allowAttachments}
      />
  ...
  return (
    <ComposerPrimitive.Root className="aui-composer-root relative flex w-full flex-col">
      {allowAttachments
        ? <ComposerPrimitive.AttachmentDropzone asChild>{shell}</ComposerPrimitive.AttachmentDropzone>
        : shell}
    </ComposerPrimitive.Root>
  );
};

const ComposerAction: FC<{ allowAttachments: boolean }> = ({ allowAttachments }) => {
  return (
    <div className="aui-composer-action-wrapper relative flex items-center justify-between">
      {allowAttachments ? <ComposerAddAttachment /> : <span aria-hidden="true" />}
...
const EditComposer: FC<{ allowAttachments: boolean }> = ({ allowAttachments }) => {
  return (
    <MessagePrimitive.Root
