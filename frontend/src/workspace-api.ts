...
export type Configuration = { execution_type: 'docker'; provider: 'openai'; model: string; profile_id: string | null; workspace: string; instructions: string; skills: Skill[] };
export type Agent = { id: string; organization_id: string; name: string; title: string; host_id: string; reports_to_agent_id: string | null; desired_version: number; applied_version: number | null; configuration_status: string; configuration: Configuration };
